...
def getJdi(df_net_oi, matches_all, ec_df, df_player_share):
    ...
    df_snoi_netoi_dist['p1'] = np.where(df_snoi_netoi_dist['playerId1'] > df_snoi_netoi_dist['playerId2'], df_snoi_netoi_dist['playerId2'], df_snoi_netoi_dist['playerId1'])
    df_snoi_netoi_dist['p2'] = np.where(df_snoi_netoi_dist['playerId1'] == df_snoi_netoi_dist['p1'], df_snoi_netoi_dist['playerId2'], df_snoi_netoi_dist['playerId1'])
    df_jdi = compute_jdi(df_snoi_netoi_dist)
    return df_jdi

def getJdi_v2(df_net_oi, matches_all, ec_df, df_player_share):
    df_snoi_netoi_dist = process_for_jdi(df_net_oi, matches_all, ec_df, df_player_share)
    #df_snoi_netoi_dist['p1'] = np.where(df_snoi_netoi_dist['playerId1'] > df_snoi_netoi_dist['playerId2'], df_snoi_netoi_dist['playerId2'], df_snoi_netoi_dist['playerId1'])
    #df_snoi_netoi_dist['p2'] = np.where(df_snoi_netoi_dist['playerId1'] == df_snoi_netoi_dist['p1'], df_snoi_netoi_dist['playerId2'], df_snoi_netoi_dist['playerId1'])
    df_jdi = compute_jdi_v2(df_snoi_netoi_dist)
    return df_snoi_netoi_dist

def get_jdi_v3(player_shares, player_distances, df_net_oi, matches_all):
    ...
    df_player_share_dist = (df_player_share_dist[['playerId1', 'matchId', 'teamId', 'zone_1_t1',
                                                'zone_2_t1', 'zone_3_t1','zone_4_t1', 'zone_5_t1',
                                                'zone_6_t1','zone_1_imp1', 'zone_2_imp1', 'zone_3_imp1',
                                                'zone_4_imp1','zone_5_imp1', 'zone_6_imp1', 'playerId2',
    ...
    df_jdi_v2 = compute_jdi_v3(df_jdi)
